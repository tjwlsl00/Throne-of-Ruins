...
public class Wizard : MonoBehaviour
{
    ...
    private Dungeon1Manager enemyManager;
    public void SetEnemyManager(Dungeon1Manager manager)
    {
    ...
    IEnumerator RepeatAttack()
    {
        ...
        {
            animator.SetTrigger(attackAnimTrigger);
            Debug.Log($"공격 실행 - 다음 공격까지 {attackInterval}초 대기");
