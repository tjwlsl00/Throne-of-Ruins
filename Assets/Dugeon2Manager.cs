...
public class Dungeon2Manager : MonoBehaviour
{
    ...
    void SpawnEnemy(Transform spawnPoint)
    {
        if (enemyPrefab != null && spawnPoint != null)
        {
            ...
            Goblin enemyScript = newEnemy.GetComponent<Goblin>();
            if (enemyScript != null)
            {
    ...
    // 적이 죽었을 때 호출될 함수
    public void EnemyDied(Goblin deadEnemy, Transform spawnPointWhereItDied)
    {
